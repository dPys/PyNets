...
def test_nodemaker_tools_masking_parlistfile_WB():
    ...
    [WB_net_parcels_map_nifti_unmasked, WB_coords_unmasked, _,
     WB_atlas_select, WB_uatlas_select, _] = nodemaker.node_gen(WB_coords, WB_parcel_list, WB_label_names, dir_path,
    ...
    [WB_net_parcels_map_nifti_masked, WB_coords_masked, WB_label_names_masked,
     WB_atlas_select, WB_uatlas_select, _] = nodemaker.node_gen_masking(mask, WB_coords, WB_parcel_list, WB_label_names,
