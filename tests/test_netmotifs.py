...
@pytest.mark.parametrize("thr", [.2, .4, .6, .8])
@pytest.mark.parametrize("N", [3, 4])
...
#     """
#     base_dir = str(Path(__file__).parent/"examples")
#     struct_mat = np.load(f"{base_dir}/miscellaneous/graphs/002_modality-func_rsn-Default_model-cov_nodetype-spheres-2mm_smooth-2fwhm_hpass-0.1Hz_thrtype-PROP_thr-0.95.npy")
#     func_mat = np.load(f"{base_dir}/miscellaneous/graphs/002_modality-func_rsn-Default_model-cov_nodetype-spheres-2mm_smooth-2fwhm_hpass-0.1Hz_thrtype-PROP_thr-0.95.npy")
#
#     name = "compare"
#     namer_dir = "tests"
#
#     mf = netmotifs.compare_motifs(struct_mat, func_mat, name, namer_dir)
