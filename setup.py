...
setup(
    ...
    install_requires=['nilearn==0.6.0b0', 'deepbrain==0.1.0'] + requirements,
    dependency_links=['git+https://github.com/dPys/nilearn.git@enh/parc_conn#egg=nilearn-0.6.0b0', 'git+https://github.com/dPys/deepbrain.git@master#egg=deepbrain-0.1.0'],
