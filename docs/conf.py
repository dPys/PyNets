...
latex_documents = [
    (master_doc, "pynets.tex", "pynets Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "pynets", "pynets Documentation", [author], 1)]
...
def autodoc_skip_member(app, what, name, obj, skip, options):
    ...
    exclude = any(exc in name for exc in exclusions)
