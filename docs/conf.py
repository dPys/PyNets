# -*- coding: utf-8 -*-
#
# pynets documentation build configuration file, created by
...
# of the sidebar.
html_logo = '_static/IMG_5484_accented.png'
...
latex_documents = [
    (master_doc, 'pynets.tex', u'pynets Documentation',
     author,
     'manual'),
]
...
man_pages = [
    (master_doc, 'pynets', u'pynets Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pynets', u'pynets Documentation',
     author, 'pynets', 'One line description of project.',
     'Miscellaneous'),
]
...
linkcode_resolve = make_linkcode_resolve('pynets',
                                         u'https://github.com/dPys/'
