...
@pytest.mark.parametrize(
    "thr,max_thr,min_thr,step_thr,multi_thr,thr_type",
    [
...
@pytest.mark.parametrize(
    ...
    [
        None,
        f"{base_dir}/BIDS/sub-25659/ses-1/anat/sub-25659_desc-brain_mask.nii.gz",
    ],
)
@pytest.mark.parametrize(
    "track_type,tiss_class,conn_model,conn_model_list",
    [
...
@pytest.mark.parametrize(
    "parc,node_radius,node_size_list,atlas,multi_atlas,parcellation,user_atlas_list",
    [
        pytest.param(
            False, None, [4, 8], None, None, None, None, marks=pytest.mark.xfail
        ),
        pytest.param(
            False, None, [4, 8], "coords_dosenbach_2010", None, None, None
        ),
        pytest.param(
            False,
            None,
        ...
        pytest.param(
            False, 4, None, None, None, None, None, marks=pytest.mark.xfail
        ),
        ...
        pytest.param(
            ...
            None,
            f"{base_dir}/miscellaneous/whole_brain_cluster_labels_"
            f"PCA200.nii.gz",
            None,
        ),
        pytest.param(
            ...
            None,
            ["coords_dosenbach_2010", "coords_power_2011"],
            f"{base_dir}/miscellaneous/whole_"
            f"brain_cluster_labels_PCA200.nii.gz",
            None,
        ),
        pytest.param(
            False,
            ...
            "coords_dosenbach_2010",
            None,
            f"{base_dir}/miscellaneous/whole_brain_cluster_labels_PCA200."
            f"nii.gz",
            None,
        ),
        pytest.param(
            ...
            None,
            ["coords_dosenbach_2010", "coords_power_2011"],
            f"{base_dir}/miscellaneous/whole_brain_"
            f"cluster_labels_PCA200.nii.gz",
            None,
        ),
        pytest.param(
            False,
...
def test_struct_all(
    ...
    dmri_connectometry_wf = workflows.dmri_connectometry(
        ID,
        atlas,
        subnet,
        node_radius,
