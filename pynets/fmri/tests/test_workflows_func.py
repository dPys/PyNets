...
@pytest.mark.parametrize(
    "parc,node_radius,node_size_list,atlas,multi_atlas,"
...
def test_func_all(
    ...
    mask = (
        f"{base_dir}/BIDS/sub-25659/ses-1/anat/sub-25659_desc-brain_"
        f"mask.nii.gz"
    )
...
@pytest.mark.parametrize(
    "k,k_list,k_clustering,clust_mask,clust_mask_list,clust_type,clust_type_list",
    [
        ...
        pytest.param(
            ...
            None,
            1,
            f"{base_dir}/miscellaneous/pDMN_3_bin.nii.gz",
            None,
            "ward",
            None,
        ),
...
@pytest.mark.parametrize(
    "roi", [f"{base_dir}/miscellaneous/pDMN_3_bin.nii.gz", None]
)
@pytest.mark.parametrize("subnet", ["Default", ["Default", "Limbic"], None])
@pytest.mark.parametrize(
