...
#TOR2011
@due.dcite(BibTeX(TOR2011), description="For generating a cube and discarding all points outside a sphere")
...
#YEO2011 SCHAEFER2018
@due.dcite(BibTeX(YEO2011), description="For evaluating the affinity of an arbitrary list of coordinate or parcel"
                                        " nodes for a specified RSN using Yeo-7 or Yeo-17 definitions")
@due.dcite(BibTeX(SCHAEFER2018), description="For evaluating the affinity of an arbitrary list of coordinate or parcel"
                                             " nodes for a specified RSN using Yeo-7 or Yeo-17 definitions")
...
#TZOURIO-MAZOYER2002
@due.dcite(BibTeX(TZOURIO-MAZOYER2002), description="For performing automated-anatomical labeling of each coordinate"
                                                    " in a list of voxel coordinates")
...
#TOR2011 TAUSCZIK2010
@due.dcite(BibTeX(TOR2011), description="For performing automated Sentiment labeling of each coordinate in a list of"
                                        " MNI coordinates")
@due.dcite(BibTeX(TAUSCZIK2010), description="For performing automated Sentiment labeling of each coordinate in"
                                             " a list of MNI coordinates")
