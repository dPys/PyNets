...
#BASC_RUN
def basc_runner(subjects_list, basc_config):
    import sys
    sys.path.insert(0,'/Users/aki.nikolaidis/git_repo/BASC')
    import basc
    import numpy as np
    import scipy.stats
    ...
    basc_config='/Users/aki.nikolaidis/git_repo/ALL_PYNETS/PyNets/pynets/basc_config.yaml'
    ...
    roi2_mask_file=basc_dict['roi2_mask_file']
